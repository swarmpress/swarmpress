...
6. [Agent Scheduling](#agent-scheduling)
7. [Collections Browser](#collections-browser)
...
**Swarm.press** is an autonomous virtual publishing house where 11+ AI agents collaboratively manage your website's content structure, SEO optimization, and publishing workflows.
...
- **Agents**: 11+ AI collaborators (Writer, Editor, QA, Media, Linker, etc.)
- **Collections**: Structured data (restaurants, accommodations, events)
- **Schedules**: Autonomous agent tasks (content publishing, link checking)
...
Autonomous agent schedules enable agents to work without human intervention.
...
| **Media Check** | Validate images and media | Daily 7 AM |
| **Link Validation** | Find broken links | Weekly Monday 8 AM |
| **Stale Content** | Identify outdated content | Monthly 1st 9 AM |

### Managing Schedules

1. Navigate to website detail page
2. Find "Agent Schedules" section
3. View/manage all configured schedules

**Actions:**
- **Enable/Disable** - Toggle schedule state
- **Run Now** - Trigger immediate execution
- **Edit Cron** - Customize timing
...
- Filter by type, status, trigger
- See duration and results
- Review error details for failures

For detailed information, see [Agent Scheduling Guide](/guides/scheduling).

---

## Collections Browser

Manage structured data collections like restaurants, accommodations, and events.

### Accessing Collections

1. Click "Collections" in the sidebar
2. Select collection type (Restaurants, Hikes, etc.)
...
- **Card View** - Preview with key info
- **Detail View** - Full data display
- **Version History** - Track changes

### Embedding in Pages

Use SlugPicker in page editor to:
1. Search collection items
2. Select items to embed
3. Drag to reorder
